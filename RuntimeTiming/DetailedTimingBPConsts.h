...
const std::unordered_map<Runtime_Type_BP, std::string> timingNames_BP = {
  ...
  {Runtime_Type_BP::LEVEL_0_DATA_COSTS, LEVEL_DCOST_BPTIME_CTIME_NAMES[0][0]}, 
  {Runtime_Type_BP::LEVEL_1_DATA_COSTS, LEVEL_DCOST_BPTIME_CTIME_NAMES[1][0]}, 
  {Runtime_Type_BP::LEVEL_2_DATA_COSTS, LEVEL_DCOST_BPTIME_CTIME_NAMES[2][0]}, 
  {Runtime_Type_BP::LEVEL_3_DATA_COSTS, LEVEL_DCOST_BPTIME_CTIME_NAMES[3][0]}, 
  {Runtime_Type_BP::LEVEL_4_DATA_COSTS, LEVEL_DCOST_BPTIME_CTIME_NAMES[4][0]},
  {Runtime_Type_BP::LEVEL_5_DATA_COSTS, LEVEL_DCOST_BPTIME_CTIME_NAMES[5][0]},
  {Runtime_Type_BP::LEVEL_6_DATA_COSTS, LEVEL_DCOST_BPTIME_CTIME_NAMES[6][0]},
  {Runtime_Type_BP::LEVEL_7_DATA_COSTS, LEVEL_DCOST_BPTIME_CTIME_NAMES[7][0]},
  {Runtime_Type_BP::LEVEL_8_DATA_COSTS, LEVEL_DCOST_BPTIME_CTIME_NAMES[8][0]},
  {Runtime_Type_BP::LEVEL_9_DATA_COSTS, LEVEL_DCOST_BPTIME_CTIME_NAMES[9][0]},
  ...
  {Runtime_Type_BP::BP_ITERS, "Total time BP Iters"},
  {Runtime_Type_BP::COPY_DATA, "Total time Copy Data"},
  ...
  {Runtime_Type_BP::LEVEL_0_BP, LEVEL_DCOST_BPTIME_CTIME_NAMES[0][1]}, 
  {Runtime_Type_BP::LEVEL_1_BP, LEVEL_DCOST_BPTIME_CTIME_NAMES[1][1]}, 
  {Runtime_Type_BP::LEVEL_2_BP, LEVEL_DCOST_BPTIME_CTIME_NAMES[2][1]}, 
  {Runtime_Type_BP::LEVEL_3_BP, LEVEL_DCOST_BPTIME_CTIME_NAMES[3][1]},
  {Runtime_Type_BP::LEVEL_4_BP, LEVEL_DCOST_BPTIME_CTIME_NAMES[4][1]}, 
  {Runtime_Type_BP::LEVEL_5_BP, LEVEL_DCOST_BPTIME_CTIME_NAMES[5][1]}, 
  {Runtime_Type_BP::LEVEL_6_BP, LEVEL_DCOST_BPTIME_CTIME_NAMES[6][1]}, 
  {Runtime_Type_BP::LEVEL_7_BP, LEVEL_DCOST_BPTIME_CTIME_NAMES[7][1]}, 
  {Runtime_Type_BP::LEVEL_8_BP, LEVEL_DCOST_BPTIME_CTIME_NAMES[8][1]}, 
  {Runtime_Type_BP::LEVEL_9_BP, LEVEL_DCOST_BPTIME_CTIME_NAMES[9][1]}, 
  {Runtime_Type_BP::LEVEL_0_COPY, LEVEL_DCOST_BPTIME_CTIME_NAMES[0][2]}, 
  {Runtime_Type_BP::LEVEL_1_COPY, LEVEL_DCOST_BPTIME_CTIME_NAMES[1][2]}, 
  {Runtime_Type_BP::LEVEL_2_COPY, LEVEL_DCOST_BPTIME_CTIME_NAMES[2][2]}, 
  {Runtime_Type_BP::LEVEL_3_COPY, LEVEL_DCOST_BPTIME_CTIME_NAMES[3][2]}, 
  {Runtime_Type_BP::LEVEL_4_COPY, LEVEL_DCOST_BPTIME_CTIME_NAMES[4][2]}, 
  {Runtime_Type_BP::LEVEL_5_COPY, LEVEL_DCOST_BPTIME_CTIME_NAMES[5][2]}, 
  {Runtime_Type_BP::LEVEL_6_COPY, LEVEL_DCOST_BPTIME_CTIME_NAMES[6][2]}, 
  {Runtime_Type_BP::LEVEL_7_COPY, LEVEL_DCOST_BPTIME_CTIME_NAMES[7][2]}, 
  {Runtime_Type_BP::LEVEL_8_COPY, LEVEL_DCOST_BPTIME_CTIME_NAMES[8][2]}, 
  {Runtime_Type_BP::LEVEL_9_COPY, LEVEL_DCOST_BPTIME_CTIME_NAMES[9][2]}, 
