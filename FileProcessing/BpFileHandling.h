...
public:
	BpFileHandling(const std::string& stereo_set_name) : stereo_set_path_(std::filesystem::current_path() / stereo_set_name), num_out_disp_map_(1) {}
	...
	std::filesystem::path getCurrentOutputDisparityFilePath()
	{
