...
void ProcessOptimizedCPUBP<T, U, DISP_VALS>::runBPAtCurrentLevel(const BPsettings& algSettings,
...
template<typename T, typename U, unsigned int DISP_VALS>
void ProcessOptimizedCPUBP<T, U, DISP_VALS>::copyMessageValuesToNextLevelDown(
		const levelProperties& currentLevelProperties,
...
template<typename T, typename U, unsigned int DISP_VALS>
void ProcessOptimizedCPUBP<T, U, DISP_VALS>::initializeDataCosts(const BPsettings& algSettings, const levelProperties& currentLevelProperties,
...
template<typename T, typename U, unsigned int DISP_VALS>
void ProcessOptimizedCPUBP<T, U, DISP_VALS>::initializeDataCurrentLevel(const levelProperties& currentLevelProperties,
...
template<typename T, typename U, unsigned int DISP_VALS>
float* ProcessOptimizedCPUBP<T, U, DISP_VALS>::retrieveOutputDisparity(
		const levelProperties& currentLevelProperties,
		const dataCostData<U>& dataCostDeviceCheckerboard,
		const checkerboardMessages<U>& messagesDevice)
{
...
template class ProcessOptimizedCPUBP<float, float*, bp_params::NUM_POSSIBLE_DISPARITY_VALUES>;
template class ProcessOptimizedCPUBP<double, double*, bp_params::NUM_POSSIBLE_DISPARITY_VALUES>;
#ifdef COMPILING_FOR_ARM
template class ProcessOptimizedCPUBP<float16_t, float16_t*>;
#else
template class ProcessOptimizedCPUBP<short, short*, bp_params::NUM_POSSIBLE_DISPARITY_VALUES>;
