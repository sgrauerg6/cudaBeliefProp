...
/**
 * @file DriverBenchmarksCUDA.cpp
 * @author Scott Grauer-Gray
 * @brief Contains the main() function that drives the optimized CUDA
 * benchmarks implementation evaluation across multiple input sizes.
 * 
 ...
 * benchmarks implementation evaluation across multiple input
...
int main(int argc, char** argv)
{
  ...
  RunImpMultTypesAccels().operator()(
    {{std::make_shared<RunImpMultInputsBnchmrks>(run_environment::AccSetting::kCUDA)}},
    run_imp_settings,
