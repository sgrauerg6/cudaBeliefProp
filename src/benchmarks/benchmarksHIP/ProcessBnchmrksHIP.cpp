...
#include "KernelBnchmrksHIP.hip"

template<RunData_t T, run_environment::AccSetting ACCELERATION, benchmarks::BenchmarkRun BENCHMARK_RUN, typename U>
std::optional<DetailedTimings<benchmarks::Runtime_Type>> ProcessBnchmrksHIP<T, ACCELERATION, BENCHMARK_RUN, U>::TwoDMatricesBnchmrk(
  ...
  U* mat_result) const
{
  ...
  hipDeviceSetCacheConfig(cudaFuncCachePreferL1);
...
template class ProcessBnchmrksHIP<float, run_environment::AccSetting::kHIP, benchmarks::BenchmarkRun::kGemm, float>;
template class ProcessBnchmrksHIP<double, run_environment::AccSetting::kHIP, benchmarks::BenchmarkRun::kGemm, double>;
template class ProcessBnchmrksHIP<halftype, run_environment::AccSetting::kHIP, benchmarks::BenchmarkRun::kGemm, halftype>;