 ...
 * @brief Contains namespace with utility functions for implementation.
 * 
...
#if defined(OPTIMIZED_CUDA_RUN) || defined(OPTIMIZED_HIP_RUN)
//added in front of function header to indicate that function is device
//function to be processed on GPU
