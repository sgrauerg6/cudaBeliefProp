...
if __name__ == "__main__":
	...
	tsukubaImageSet = {"RefImage" : "\"tsukuba/scene1.row3.col3.ppm\"", "TestImage" : "\"tsukuba/scene1.row3.col4.ppm\"", "CompGpuDispMap" : "\"tsukuba/computedDisparityMapTsukubaGPU.pgm\"", "CompCpuDispMap" : "\"tsukuba/computedDisparityMapTsukubaCPU.pgm\"", "NumDispVals" : "16", "ScaleBp" : "16.0f", "GroundTruthDisp" : "\"tsukuba/truedisp.row3.col3.pgm\"", "GroundTruthDispScale" : "16.0f", "bpLevelsImageSet" : 1}
	venusImageSet = {"RefImage" : "\"venus/im2.ppm\"", "TestImage" : "\"venus/im6.ppm\"", "CompGpuDispMap" : "\"venus/computedDisparityMapTsukubaGPU.pgm\"", "CompCpuDispMap" : "\"venus/computedDisparityMapTsukubaCPU.pgm\"", "NumDispVals" : "21", "ScaleBp" : "8.0f", "GroundTruthDisp" : "\"venus/disp2.pgm\"", "GroundTruthDispScale" : "8.0f", "bpLevelsImageSet" : 1}
	barn1ImageSet = {"RefImage" : "\"barn1/im2.ppm\"", "TestImage" : "\"barn1/im6.ppm\"", "CompGpuDispMap" : "\"barn1/computedDisparityMapTsukubaGPU.pgm\"", "CompCpuDispMap" : "\"barn1/computedDisparityMapTsukubaCPU.pgm\"", "NumDispVals" : "32", "ScaleBp" : "8.0f", "GroundTruthDisp" : "\"barn1/disp2.pgm\"", "GroundTruthDispScale" : "8.0f", "bpLevelsImageSet" : 1}
	conesImageSetQuarterSize = {"RefImage" : "\"cones/im2.ppm\"", "TestImage" : "\"cones/im6.ppm\"", "CompGpuDispMap" : "\"cones/computedDisparityMapTsukubaGPU.pgm\"", "CompCpuDispMap" : "\"cones/computedDisparityMapTsukubaCPU.pgm\"", "NumDispVals" : "63", "ScaleBp" : "4.0f", "GroundTruthDisp" : "\"cones/disp2.pgm\"", "GroundTruthDispScale" : "4.0f", "bpLevelsImageSet" : 1}
	conesImageSetHalfSize = {"RefImage" : "\"conesH/im2.ppm\"", "TestImage" : "\"conesH/im6.ppm\"", "CompGpuDispMap" : "\"conesH/computedDisparityMapTsukubaGPU.pgm\"", "CompCpuDispMap" : "\"conesH/computedDisparityMapTsukubaCPU.pgm\"", "NumDispVals" : "127", "ScaleBp" : "2.0f", "GroundTruthDisp" : "\"conesH/disp2.pgm\"", "GroundTruthDispScale" : "2.0f", "bpLevelsImageSet" : 1}
	...
	numBpLevelsAndIters = [{"bpLevels" : 5, "bpIters" : 100}]
	...
	firstLine = True
	optimizedMemory = [1]
	beliefPropDataTypeProcessing = ["0", "2", "3"]
	...
	for i in range(len(imageSets)*len(numBpLevelsAndIters)*len(truncationDiscontCost)*len(truncationDataCost)*len(dataCostWeight)*len(smoothImagesSigma)*len(optimizedMemory)*len(beliefPropDataTypeProcessing)*len(indexOptimizationSettings)):
