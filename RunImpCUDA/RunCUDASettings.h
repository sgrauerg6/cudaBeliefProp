...
const std::vector<std::array<unsigned int, 2>> kParallelParameterOptions{{16, 1}, {32, 4}, {64, 4}};
#else
const std::vector<std::array<unsigned int, 2>> kParallelParameterOptions{{16, 1}, {32, 1}, {32, 2}, {32, 3}, {32, 4}, {32, 5},
