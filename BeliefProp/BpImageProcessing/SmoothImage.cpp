...
std::pair<std::vector<float>, unsigned int> SmoothImage::MakeFilter(float sigma)
{
...
void SmoothImage::NormalizeFilter(std::vector<float>& filter, unsigned int size_filter)
{
  float sum{0.0f};
