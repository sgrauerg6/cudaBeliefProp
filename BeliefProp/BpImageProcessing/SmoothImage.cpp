...
std::pair<std::vector<float>, unsigned int> SmoothImage::MakeFilter(float sigma) const
{
...
void SmoothImage::NormalizeFilter(std::vector<float>& filter, unsigned int size_filter) const
{
  float sum{0.0};
