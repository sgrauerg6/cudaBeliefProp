...
void BpParallelParams::SetParallelDims(const std::array<unsigned int, 2>& parallel_dims) {
  parallel_dims_each_kernel_[static_cast<unsigned int>(beliefprop::BpKernel::kBlurImages)] = {parallel_dims};
  parallel_dims_each_kernel_[static_cast<unsigned int>(beliefprop::BpKernel::kDataCostsAtLevel)] = std::vector<std::array<unsigned int, 2>>(num_levels_, parallel_dims);
  parallel_dims_each_kernel_[static_cast<unsigned int>(beliefprop::BpKernel::kInitMessageVals)] = {parallel_dims};
  parallel_dims_each_kernel_[static_cast<unsigned int>(beliefprop::BpKernel::kBpAtLevel)] = std::vector<std::array<unsigned int, 2>>(num_levels_, parallel_dims);
  parallel_dims_each_kernel_[static_cast<unsigned int>(beliefprop::BpKernel::kCopyAtLevel)] = std::vector<std::array<unsigned int, 2>>(num_levels_, parallel_dims);
  parallel_dims_each_kernel_[static_cast<unsigned int>(beliefprop::BpKernel::kOutputDisp)] = {parallel_dims};
}
