...
template<> inline void beliefpropCPU::msgStereoSIMD<short, __m128i, bp_params::kStereoSetsToProcess[0].numDispVals_>(
  unsigned int xVal, unsigned int yVal,
  const beliefprop::LevelProperties& currentLevelProperties,
  __m128i messageValsNeighbor1[bp_params::kStereoSetsToProcess[0].numDispVals_],
  __m128i messageValsNeighbor2[bp_params::kStereoSetsToProcess[0].numDispVals_],
  __m128i messageValsNeighbor3[bp_params::kStereoSetsToProcess[0].numDispVals_],
  __m128i dataCosts[bp_params::kStereoSetsToProcess[0].numDispVals_],
  short* dstMessageArray, const __m128i& disc_k_bp, bool dataAligned)
{
  msgStereoSIMDProcessing<short, __m128i, float, __m256, bp_params::kStereoSetsToProcess[0].numDispVals_>(
...
// compute current message
template<> inline void beliefpropCPU::msgStereoSIMD<short, __m128i, bp_params::kStereoSetsToProcess[1].numDispVals_>(
  unsigned int xVal, unsigned int yVal,
  const beliefprop::LevelProperties& currentLevelProperties,
  __m128i messageValsNeighbor1[bp_params::kStereoSetsToProcess[1].numDispVals_],
  __m128i messageValsNeighbor2[bp_params::kStereoSetsToProcess[1].numDispVals_],
  __m128i messageValsNeighbor3[bp_params::kStereoSetsToProcess[1].numDispVals_],
  __m128i dataCosts[bp_params::kStereoSetsToProcess[1].numDispVals_],
  short* dstMessageArray, const __m128i& disc_k_bp, bool dataAligned)
{
  msgStereoSIMDProcessing<short, __m128i, float, __m256, bp_params::kStereoSetsToProcess[1].numDispVals_>(
    xVal, yVal, currentLevelProperties, messageValsNeighbor1, messageValsNeighbor2,
    messageValsNeighbor3, dataCosts, dstMessageArray, disc_k_bp, dataAligned);
}

// compute current message
template<> inline void beliefpropCPU::msgStereoSIMD<short, __m128i, bp_params::kStereoSetsToProcess[2].numDispVals_>(
  unsigned int xVal, unsigned int yVal,
  const beliefprop::LevelProperties& currentLevelProperties,
  __m128i messageValsNeighbor1[bp_params::kStereoSetsToProcess[2].numDispVals_],
  __m128i messageValsNeighbor2[bp_params::kStereoSetsToProcess[2].numDispVals_],
  __m128i messageValsNeighbor3[bp_params::kStereoSetsToProcess[2].numDispVals_],
  __m128i dataCosts[bp_params::kStereoSetsToProcess[2].numDispVals_],
  short* dstMessageArray, const __m128i& disc_k_bp, bool dataAligned)
{
  msgStereoSIMDProcessing<short, __m128i, float, __m256, bp_params::kStereoSetsToProcess[2].numDispVals_>(
    xVal, yVal, currentLevelProperties, messageValsNeighbor1, messageValsNeighbor2,
    messageValsNeighbor3, dataCosts, dstMessageArray, disc_k_bp, dataAligned);
}

// compute current message
template<> inline void beliefpropCPU::msgStereoSIMD<short, __m128i, bp_params::kStereoSetsToProcess[3].numDispVals_>(
  unsigned int xVal, unsigned int yVal,
  const beliefprop::LevelProperties& currentLevelProperties,
  __m128i messageValsNeighbor1[bp_params::kStereoSetsToProcess[3].numDispVals_],
  __m128i messageValsNeighbor2[bp_params::kStereoSetsToProcess[3].numDispVals_],
  __m128i messageValsNeighbor3[bp_params::kStereoSetsToProcess[3].numDispVals_],
  __m128i dataCosts[bp_params::kStereoSetsToProcess[3].numDispVals_],
  short* dstMessageArray, const __m128i& disc_k_bp, bool dataAligned)
{
  msgStereoSIMDProcessing<short, __m128i, float, __m256, bp_params::kStereoSetsToProcess[3].numDispVals_>(
    xVal, yVal, currentLevelProperties, messageValsNeighbor1, messageValsNeighbor2,
    messageValsNeighbor3, dataCosts, dstMessageArray, disc_k_bp, dataAligned);
}

// compute current message
template<> inline void beliefpropCPU::msgStereoSIMD<short, __m128i, bp_params::kStereoSetsToProcess[4].numDispVals_>(
  unsigned int xVal, unsigned int yVal,
  const beliefprop::LevelProperties& currentLevelProperties,
  __m128i messageValsNeighbor1[bp_params::kStereoSetsToProcess[4].numDispVals_],
  __m128i messageValsNeighbor2[bp_params::kStereoSetsToProcess[4].numDispVals_],
  __m128i messageValsNeighbor3[bp_params::kStereoSetsToProcess[4].numDispVals_],
  __m128i dataCosts[bp_params::kStereoSetsToProcess[4].numDispVals_],
  short* dstMessageArray, const __m128i& disc_k_bp, bool dataAligned)
{
  msgStereoSIMDProcessing<short, __m128i, float, __m256, bp_params::kStereoSetsToProcess[4].numDispVals_>(
    xVal, yVal, currentLevelProperties, messageValsNeighbor1, messageValsNeighbor2,
    messageValsNeighbor3, dataCosts, dstMessageArray, disc_k_bp, dataAligned);
}

// compute current message
template<> inline void beliefpropCPU::msgStereoSIMD<short, __m128i, bp_params::kStereoSetsToProcess[5].numDispVals_>(
  unsigned int xVal, unsigned int yVal,
  const beliefprop::LevelProperties& currentLevelProperties,
  __m128i messageValsNeighbor1[bp_params::kStereoSetsToProcess[5].numDispVals_],
  __m128i messageValsNeighbor2[bp_params::kStereoSetsToProcess[5].numDispVals_],
  __m128i messageValsNeighbor3[bp_params::kStereoSetsToProcess[5].numDispVals_],
  __m128i dataCosts[bp_params::kStereoSetsToProcess[5].numDispVals_],
  short* dstMessageArray, const __m128i& disc_k_bp, bool dataAligned)
{
  msgStereoSIMDProcessing<short, __m128i, float, __m256, bp_params::kStereoSetsToProcess[5].numDispVals_>(
    xVal, yVal, currentLevelProperties, messageValsNeighbor1, messageValsNeighbor2,
    messageValsNeighbor3, dataCosts, dstMessageArray, disc_k_bp, dataAligned);
}

// compute current message
template<> inline void beliefpropCPU::msgStereoSIMD<short, __m128i, bp_params::kStereoSetsToProcess[6].numDispVals_>(
  unsigned int xVal, unsigned int yVal,
  const beliefprop::LevelProperties& currentLevelProperties,
  __m128i messageValsNeighbor1[bp_params::kStereoSetsToProcess[6].numDispVals_],
  __m128i messageValsNeighbor2[bp_params::kStereoSetsToProcess[6].numDispVals_],
  __m128i messageValsNeighbor3[bp_params::kStereoSetsToProcess[6].numDispVals_],
  __m128i dataCosts[bp_params::kStereoSetsToProcess[6].numDispVals_],
  short* dstMessageArray, const __m128i& disc_k_bp, bool dataAligned)
{
  msgStereoSIMDProcessing<short, __m128i, float, __m256, bp_params::kStereoSetsToProcess[6].numDispVals_>(
    xVal, yVal, currentLevelProperties, messageValsNeighbor1, messageValsNeighbor2,
    messageValsNeighbor3, dataCosts, dstMessageArray, disc_k_bp, dataAligned);
}
