...
namespace RunAndEvaluateBpResults {
  ...
  template<BpData_t T, unsigned int DISP_VALS_OPTIMIZED, unsigned int DISP_VALS_SINGLE_THREAD, beliefprop::AccSetting OPT_IMP_ACCEL>
  ...
  template<BpData_t T, unsigned int NUM_SET, unsigned int DISP_VALS_TEMPLATE_OPTIMIZED, beliefprop::AccSetting ACC_SETTING>
  ...
  template<BpData_t T, unsigned int NUM_SET, beliefprop::AccSetting OPT_IMP_ACCEL, unsigned int DISP_VALS_TEMPLATE_OPTIMIZED, unsigned int DISP_VALS_TEMPLATE_SINGLE_THREAD>
  ...
  template<BpData_t T, unsigned int NUM_SET, bool TEMPLATED_DISP_IN_OPT_IMP, beliefprop::AccSetting OPT_IMP_ACCEL>
  std::pair<beliefprop::Status, std::vector<RunData>> runBpOnSetAndUpdateResults() {
  ...
  template <beliefprop::AccSetting OPT_IMP_ACCEL, bool MULT_DATA_TYPES, BpData_t T = float>
