...
private:
  ...
  void WriteRunOutput(const std::pair<MultRunData, std::vector<MultRunSpeedup>>& run_output,
  ...
  std::vector<MultRunSpeedup> GetSpeedupOverBaseline(
    const run_environment::RunImpSettings& run_imp_settings,
  ...
  std::vector<MultRunSpeedup> GetSpeedupOverBaselineSubsets(
    const run_environment::RunImpSettings& run_imp_settings,
    MultRunData& run_data_all_runs, size_t data_type_size) const;
